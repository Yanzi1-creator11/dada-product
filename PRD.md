...
> 本节用于回答 v3.1 诊断报告中的关键问题。标注“【用户已确认】”的内容来自既有沟通；标注“【AI 补充，待确认】”的内容是为保证首版可开发、可测试而给出的默认方案，不代表已经完成用户调研或业务验证。

| 编号 | 决策结论 | 决策来源 |
|---|---|---|
| KD-01 | 产品名称使用“搭哒”。本期产品形态按微信小程序设计。 | 产品名称为【用户已确认】；微信小程序为【AI 补充，待确认】，依据原申请书中的产品设想。 |
| KD-02 | 本期为 0→1 的可运行首版。校内认证、站内通知和 AI 话术均使用模拟服务，但通过统一接口封装，页面持续显示“模拟”标识。 | 模拟认证为【用户已确认】；接口封装为【AI 补充，待确认】。 |
| KD-03 | 候选对象是一条有效的“找搭子需求”，候选卡同时展示该需求的发布者。一个用户存在多条不同时段需求时，可分别成为候选；同一候选需求只出现一次。 | 【AI 补充，待确认】 |
| KD-04 | 用户接受与自己需求时间重叠的邀请前，系统必须展示影响确认页。接受后，重叠的个人需求转为“已暂停”，该需求发出的待回复邀请全部撤回并通知相关受邀者；用户可在退出活动后手动恢复未过期且时间未开始的需求。 | 【AI 补充，待确认】 |
| KD-05 | “当前人数”由系统根据成员记录计算，发布者固定计为 1 人；首版不支持录入未注册的线下成员。 | 【AI 补充，待确认】 |
| KD-06 | 目标总人数允许 2—4 人，包含发布者。每条需求最多同时存在 5 条待回复或暂时满员的有效邀请。 | 多人、5 条邀请为【用户已确认】；2—4 人为【AI 补充，待确认】。 |
| KD-07 | 一条需求只支持一个日期和一个连续时间段；选择粒度为 15 分钟；开始时间必须晚于服务端当前时间 30 分钟；单次时长为 30 分钟至 8 小时；可预约未来 14 天。双方时间交集至少为 30 分钟。 | 30 分钟为【用户已确认】；其余为【AI 补充，待确认】。 |
| KD-08 | 具体事项优先从受控词表单选；“其他”需要输入 2—20 个字符。首版词表只作为产品配置和测试词表，不表述为调研结论。 | 受控词表方案为【AI 补充，待确认】。 |
| KD-09 | 自身性别必须完成一次选择，选项为男、女、其他、不愿透露；搭子性别偏好为多选，默认“不限”，“不限”与其他选项互斥。候选卡不展示性别原值，只展示“双方偏好符合”。 | 性别选项、无偏好选项及提示要求为【用户已确认】；多选和展示方案为【AI 补充，待确认】。 |
| KD-10 | 线上需求不限制校区；线下需求首版只匹配同一学校、同一校区。校区词表由产品配置，模拟认证账号预置学校和可选校区。 | 同校为【用户已确认】；同校区规则为【AI 补充，待确认】。 |
| KD-11 | 达到目标人数后显示“已找齐 X/Y 人”，不自动关闭。发布者可主动“结束招募”；活动开始前可以“取消活动”，取消后所有有效邀请失效并通知成员。 | 不自动关闭为【用户已确认】；结束招募和取消规则为【AI 补充，待确认】。 |
| KD-12 | 只有发布者可以直接创建或修改安排版本；其他已加入成员可提交修改建议。发布者保存新版本时使用版本号校验，出现并发冲突则要求刷新后重试。 | 【AI 补充，待确认】 |
| KD-13 | 新成员加入且安排字段未改变时，只要求新成员确认；成员退出不重置其他成员确认。日期、开始时间、结束时间、参与方式、校区或集合地点发生变化时，创建新版本并重置全员确认。 | 【AI 补充，待确认】 |
| KD-14 | 联系方式类型支持微信号、手机号和其他，用户加入活动后可主动公开。联系方式加密保存；活动结束 30 天后删除。 | 允许公开联系方式为【用户已确认】；类型和保留期限为【AI 补充，待确认】。 |
| KD-15 | 上线后的首个效果评估周期为连续 4 周，且至少积累 100 条有效发布需求；在样本条件满足前只建立基线，不承诺增长目标。 | 【AI 补充，待确认】 |
...
| 项目 | 内容 | 来源状态 |
|---|---|---|
| 文档标题 | 搭哒同校找搭子平台产品需求文档 | 【原文已有】 |
| 版本号 | PRD v4.0 | 【AI 补充，待确认】 |
| 产品名称 | 搭哒 | 【用户已确认】 |
| 产品形态 | 微信小程序 | 【AI 补充，待确认】 |
| 产品类型 | To C | 【AI 补充，待确认】 |
| 所属行业 | 校园生活服务 | 【AI 补充，待确认】 |
| 目标用户 | 有运动、学习或娱乐搭子需求的同校用户 | 【原文已有】 |
| 需求性质 | 0→1 新产品 | 【AI 补充，待确认】 |
| 当前阶段 | 评审前 | 【AI 补充，待确认】 |
| 文档状态 | 评审中 | 【AI 补充，待确认】 |
| 作者 | 【待产品确认：文档作者】 | 待确认 |
| 创建日期 | 2026-09-14 | 【原文已有】 |
| 更新日期 | 2026-09-16 | 本次更新 |
...
| 测试负责人 | 【待产品确认】 |
| 数据负责人 | 【待产品确认】 |
| 运营负责人 | 本期不涉及；首版无独立运营后台。【AI 补充，待确认】 |

## 0.3 变更记录

| 版本 | 日期 | 修改人 | 修改内容 |
|---|---|---|---|
| v3.1 | 2026-09-14 | 【待产品确认】 | 扩展为运动、学习、娱乐三类同校找搭子平台。【原文已有】 |
| v4.0 | 2026-09-16 | 【待产品确认】 | 按评审级 PRD 结构重组，补充 FR、BR、NFR、EV、状态机、异常与验收映射。【AI 补充，待确认】 |
...
|---|---|---|
| 项目申请书 | 已有 | 【待产品补充链接】 |
| MRD | 本期不单独提供；需求依据合并在本 PRD 第 1—3 章。【AI 补充，待确认】 | — |
| 交互原型 | 待产出 | 【待设计补充】 |
| UI 设计稿 | 待产出 | 【待设计补充】 |
| 技术方案 | 待技术评审 | 【待研发补充】 |
| 接口文档 | 待技术评审 | 【待研发补充】 |
...
- 【用户已确认】：用户在现有沟通中已经明确拍板的规则。
- 【原文已有】：v3.1 已经存在，但不代表已被真实数据验证。
- 【材料记载】：原申请书中的陈述；缺少原始材料时不能当作已复核事实。
- 【待验证假设】：必须通过原始访谈、问卷或真实试点验证。
- 【AI 补充，待确认】：为形成可开发、可测试方案而新增的默认规则。
- 【待产品确认】：无法根据现有材料安全推断的业务决策。
...
【材料记载】原申请书将产品设想为面向大学生的轻量化搭子平台，覆盖运动、学习和兴趣活动，并计划采用微信小程序。申请书中记载了访谈、问卷和公开内容采集数量，但当前没有原始问卷、样本结构、访谈纪要和清洗数据，因此不能据此声明需求已经被验证。

【待验证假设】同校用户在聊天群、朋友圈或熟人关系中寻找搭子时，事项、时间、地点、人数和参与要求分散，需要重复询问；发布者难以确认谁真正符合条件，参与者也可能在接受前无法看清安排。

【原文已有】首版聚焦“围绕一件具体事项找人并确认安排”，不承载社区内容流。运动、学习和娱乐共用发布、筛选、邀请、接受和安排确认流程。

## 1.2 需求目标

| 目标编号 | 目标 | 验证方式 | 来源状态 |
|---|---|---|---|
| OBJ-01 | 用户可以完成一条字段合法的找搭子需求发布。 | 发布成功事件与字段校验用例全部通过。 | 【原文已有】 |
| OBJ-02 | 候选仅由公开硬规则产生，无合格候选时返回空结果。 | 使用固定测试集复算候选结果，前后端结果一致。 | 【用户已确认】 |
| OBJ-03 | 支持 2—4 人活动的邀请、接受、满员、退出和恢复招募。 | 状态机与并发验收用例通过。 | 【AI 补充，待确认】 |
| OBJ-04 | 所有当前成员能够确认同一版活动安排。 | 安排版本与逐人确认记录一致。 | 【原文已有】 |
| OBJ-05 | AI 只生成三条可编辑、可复制的话术，未经用户操作不得发送。 | AI 权限和发送边界用例通过。 | 【用户已确认】 |
| OBJ-06 | 模拟认证、模拟通知和模拟 AI 在所有相关页面持续可见。 | 页面巡检和 UI 自动化用例通过。 | 【用户已确认】 |

## 1.3 核心指标

> 【AI 补充，待确认】业务指标在首个评估周期内只建立基线。没有真实上线数据前，不写入虚构的当前值或增长目标。
...
【待验证假设】对用户的价值是减少反复询问，在接受邀请前明确事项、时间、参与方式和人数，并在成员变化时看到真实状态。

【AI 补充，待确认】对产品的价值是验证“结构化需求 + 规则匹配 + 邀请确认”是否足以支持同校找搭子，而不依赖内容社区或完整即时通讯。

【AI 补充，待确认】若不做本期能力，无法验证跨运动、学习、娱乐的通用找搭子流程，也无法形成候选为空、多人并发和安排版本等关键场景的真实行为数据。
...
| 用户角色 | 特征 | 使用动机 | 预期频次 | 来源状态 |
|---|---|---|---|---|
| 需求发布者 | 同校用户；已完成模拟认证；有明确事项和大致时间 | 找到满足必要条件的人并组织活动 | 事件触发型，不设固定频次 | 【原文已有】 |
| 受邀者 | 自己也存在有效需求，或被其他需求匹配 | 在接受前确认共同条件、差异和时间 | 事件触发型 | 【原文已有】 |
| 已加入成员 | 已接受邀请并进入活动 | 确认安排、选择是否公开联系方式、必要时退出 | 每次活动 1 次以上 | 【原文已有】 |

## 2.2 用户故事

| 编号 | 用户故事 | 来源状态 |
|---|---|---|
| US-001 | 作为需求发布者，在想找同校用户一起完成具体事项时，我想填写事项、时间、参与方式、人数和必要偏好，以便获得符合硬条件的候选。 | 【原文已有】 |
| US-002 | 作为需求发布者，在查看候选时，我想看到候选出现的可复核理由和仍需协商的差异，以便决定是否邀请。 | 【原文已有】 |
| US-003 | 作为受邀者，在收到邀请时，我想在接受前看到完整需求、剩余名额和截止时间，以便判断是否参加。 | 【原文已有】 |
| US-004 | 作为发布者，在邀请多人时，我想让系统控制待回复上限和剩余名额，以便避免超员。 | 【用户已确认】 |
| US-005 | 作为已加入成员，在活动安排发生变化时，我想看到具体差异并确认新版本，以便所有人对同一安排达成一致。 | 【原文已有】 |
| US-006 | 作为已加入成员，在不知道如何开场时，我想主动生成并编辑破冰话术，以便由我决定是否复制和发送。 | 【用户已确认】 |
| US-007 | 作为重视隐私的用户，我想控制性别信息和联系方式的可见范围，以便在不公开敏感信息的情况下参与匹配。 | 【原文已有】 |

## 2.3 用户痛点与替代方案

| 场景 | 当前替代方案 | 待验证痛点 | 本期方案 |
|---|---|---|---|
...
【待产品确认】当前没有提供可复核的竞品截图、版本、采集日期或体验记录，因此本版不输出竞品优劣结论，避免把常识性判断写成竞品事实。
...
| 能力 | 本期结论 | 原因 |
|---|---|---|
| 社区动态、内容推荐流、关注关系 | 本期不涉及 | 产品只解决具体事项找人。【用户已确认】 |
| 支付、担保交易、费用分摊 | 本期不涉及 | 不属于首版找人闭环。【用户已确认】 |
| 实时定位和轨迹 | 本期不涉及 | 校区和集合地点足以支持首版安排。【用户已确认】 |
| 复杂用户画像、信用分、AI 匹配分 | 本期不涉及 | 缺少数据依据，且无法解释。【用户已确认】 |
| 完整即时通讯、群聊和已读回执 | 本期不涉及 | 首版使用结构化安排和外部联系方式。【用户已确认】 |
| 真实校园身份系统接入 | 本期不涉及 | 当前无法接入，使用持续标注的模拟认证。【用户已确认】 |
| 运营后台 | 本期不涉及 | 词表和测试账号先由配置文件维护。【AI 补充，待确认】 |
| 举报与处罚工作台 | 本期不涉及 | 首版不建设后台；但需保留用户屏蔽能力，见 FR-011。【AI 补充，待确认】 |
...
| 功能编号 | 模块 | 功能点 | 描述 | 优先级 | 所属端 | 来源状态 |
|---|---|---|---|---|---|---|
| FR-001 | 身份 | 模拟校内认证 | 选择测试账号并形成学校、校区和模拟认证状态 | P0 | 小程序 | 【用户已确认】 |
| FR-002 | 需求 | 发布与管理需求 | 新建、编辑、暂停、恢复、结束招募和取消需求 | P0 | 小程序 | 【原文已有】 |
| FR-003 | 匹配 | 候选筛选与排序 | 按硬条件返回候选并提供可复核解释 | P0 | 小程序/服务端 | 【用户已确认】 |
| FR-004 | 邀请 | 发送邀请 | 二次确认、去重、上限和三小时有效期 | P0 | 小程序/服务端 | 【用户已确认】 |
| FR-005 | 邀请 | 处理邀请 | 接受、拒绝、撤回、到期、暂时满员 | P0 | 小程序/服务端 | 【原文已有】 |
| FR-006 | 活动 | 多人名额与成员 | 2—4 人、已找齐、退出和恢复招募 | P0 | 小程序/服务端 | 【用户已确认】 |
| FR-007 | 安排 | 安排版本与确认 | 创建安排、逐人确认、修改和版本重置 | P0 | 小程序/服务端 | 【原文已有】 |
| FR-008 | 隐私 | 联系方式公开 | 已加入成员主动公开、关闭和退出后隐藏 | P1 | 小程序/服务端 | 【用户已确认】 |
| FR-009 | AI 辅助 | AI 破冰话术 | 主动生成三条话术，可编辑、复制、不代发 | P1 | 小程序/模拟服务 | 【用户已确认】 |
| FR-010 | 通知 | 模拟站内通知 | 关键状态变化生成可读通知并跳转详情 | P1 | 小程序/模拟服务 | 【原文已有】 |
| FR-011 | 安全 | 屏蔽用户 | 屏蔽后双方不再成为候选，已有邀请失效 | P1 | 小程序/服务端 | 【AI 补充，待确认】 |
| FR-012 | 数据 | 行为埋点 | 记录非敏感行为事件并支持指标计算 | P1 | 小程序/服务端 | 【原文已有】 |
...
以上权限矩阵中的发布者退出限制和屏蔽功能为【AI 补充，待确认】；其余主要权限沿用原文。
...
| 项目 | 统一规则 | 来源状态 |
|---|---|---|
| 服务端时间 | 所有截止时间、活动开始时间和过期判断以服务端时间为准；客户端只负责展示。 | 【AI 补充，待确认】 |
| 防重复提交 | 提交类按钮点击后立即进入加载态；响应前禁止再次点击；服务端使用业务幂等键去重。 | 【AI 补充，待确认】 |
| 错误展示 | 字段错误显示在对应字段下方；页面级错误显示在页面顶部，不清空用户输入。 | 【AI 补充，待确认】 |
| 网络失败 | 展示“网络连接失败，请检查网络后重试”；读取失败允许重试，写入失败先查询服务端结果再决定是否重发。 | 【AI 补充，待确认】 |
| 权限不足 | 返回统一无权限状态，不展示目标对象的敏感信息。 | 【AI 补充，待确认】 |
| 模拟标识 | 模拟认证、模拟通知和模拟 AI 在对应内容附近显示“模拟能力”标签，不能只在首次进入时提示。 | 【用户已确认】 |
| 加载态 | 首次加载显示骨架屏；超过 10 秒未完成则结束加载并显示重试入口。 | 【AI 补充，待确认】 |
| 空数据 | 不插入虚构数据；说明为空的原因和用户可以执行的下一步。 | 【用户已确认】 |

## 6.1 FR-001 模拟校内认证

### 功能描述

【用户已确认】用户进入发布、候选、邀请和活动能力前，必须完成模拟校内认证。模拟认证只提供测试账号、学校和校区字段，不代表接入真实校园身份系统。
...
| 字段名 | 类型 | 必填 | 长度或范围 | 默认值 | 校验规则 | 错误文案 | 数据来源 | 来源状态 |
|---|---|---:|---|---|---|---|---|---|
| 测试账号 | 单选 | 是 | 配置列表 | 未选择 | 必须选择有效且启用的账号 | 请选择测试账号 | 测试账号配置 | 【AI 补充，待确认】 |
| 学校 | 只读文本 | 是 | 1—50 字 | 随账号 | 不允许用户修改 | 测试账号学校信息不可用 | 测试账号配置 | 【AI 补充，待确认】 |
| 校区 | 只读文本 | 是 | 1—30 字 | 随账号 | 必须属于学校校区词表 | 测试账号校区信息不可用 | 校区配置 | 【AI 补充，待确认】 |
| 模拟知情确认 | 复选框 | 是 | 布尔值 | 否 | 提交前必须勾选 | 请确认你已知晓当前使用模拟认证 | 用户输入 | 【AI 补充，待确认】 |
...
【原文已有】用户发布运动、学习或娱乐需求，并管理草稿、招募、暂停、恢复、结束招募和取消状态。一级类别共用通用字段，类别补充字段只展示，不参与首版自动过滤。
...
| 字段名 | 类型 | 必填 | 长度或范围 | 默认值 | 校验规则 | 错误提示 | 数据来源 | 来源状态 |
|---|---|---:|---|---|---|---|---|---|
| 一级类别 | 单选枚举 | 是 | 运动、学习、娱乐 | 入口类别 | 三选一 | 请选择需求类别 | 用户输入 | 【用户已确认】 |
| 具体事项 | 单选 + 文本 | 是 | 受控词表；其他为 2—20 字 | 未选择 | 去除首尾空格；不允许只填“其他”；禁止仅符号 | 请选择具体事项或填写 2—20 个字符 | 词表/用户输入 | 【AI 补充，待确认】 |
| 活动日期 | 日期 | 是 | 今天至未来第 14 天 | 未选择 | 不得早于服务端当天 | 请选择未来 14 天内的日期 | 用户输入 | 【AI 补充，待确认】 |
| 开始时间 | 时间 | 是 | 15 分钟粒度 | 未选择 | 至少晚于服务端当前时间 30 分钟 | 开始时间需晚于当前时间至少 30 分钟 | 用户输入 | 【AI 补充，待确认】 |
| 结束时间 | 时间 | 是 | 15 分钟粒度 | 未选择 | 晚于开始；时长 30 分钟至 8 小时 | 活动时长需为 30 分钟至 8 小时 | 用户输入 | 【AI 补充，待确认】 |
| 参与方式 | 单选枚举 | 是 | 线上、线下 | 线下 | 二选一 | 请选择参与方式 | 用户输入 | 【原文已有】 |
| 校区 | 单选枚举 | 线下必填 | 当前学校启用校区 | 认证校区 | 必须为当前学校有效校区 | 请选择活动校区 | 校区配置 | 【AI 补充，待确认】 |
| 目标总人数 | 整数 | 是 | 2—4，包含发布者 | 2 | 不得小于当前人数 | 目标人数需为 2—4 人且不少于当前人数 | 用户输入 | 【AI 补充，待确认】 |
| 自身性别 | 单选枚举 | 是 | 男、女、其他、不愿透露 | 未选择 | 必须主动选择，不根据头像推断 | 请选择自身性别或“不愿透露” | 用户输入 | 【用户已确认】 |
| 搭子性别偏好 | 多选枚举 | 是 | 不限、男、女、其他 | 不限 | 不限与其他选项互斥 | “不限”不能与其他偏好同时选择 | 用户输入 | 【AI 补充，待确认】 |
| 补充说明 | 多行文本 | 否 | 0—50 字 | 空 | 去除首尾空格；禁止联系方式和违法内容 | 补充说明最多 50 字，且不能填写联系方式 | 用户输入 | 【原文已有】 |
| 类别补充字段 | 文本/枚举 | 否 | 单项 0—30 字 | 空 | 只展示，不参与自动过滤 | 单项内容不能超过 30 字 | 用户输入 | 【AI 补充，待确认】 |

### 首版事项配置

| 类别 | 初始配置词 | 说明 |
|---|---|---|
| 运动 | 羽毛球、跑步、篮球、乒乓球、健身、其他 | 【AI 补充，待确认】仅用于首版配置和测试，不代表调研频次。 |
| 学习 | 同伴自习、课程复习、考试备考、语言练习、技能学习、其他 | 【AI 补充，待确认】仅用于首版配置和测试。 |
| 娱乐 | 桌游、观影、逛展、摄影、探店、其他 | 【AI 补充，待确认】仅用于首版配置和测试。 |

### 业务规则

- BR-005：同一用户可以创建多条需求，但时间重叠的有效需求最多 1 条处于招募状态。【AI 补充，待确认】
...
【用户已确认】服务端以其他用户的有效需求为候选对象，先执行硬条件过滤，再执行确定性排序。无合格候选时返回空数组，不创建模拟推荐。
...
【原文已有】发布者从候选详情发起邀请。系统在发送前校验有效邀请上限、重复邀请、需求状态、活动时间和候选资格，并生成有效期不超过 3 小时的邀请。
...
| 邀请补充语 | 单行文本 | 否 | 0—50 字，不允许联系方式【AI 补充，待确认】 | 空 |
...
- BR-029：距离活动开始不足 30 分钟时禁止发送新邀请。【AI 补充，待确认】
...
【原文已有】用户在“我的邀请”中查看收到和发出的邀请。受邀者可接受或拒绝，发布者可在接受前撤回；系统处理到期、资格变化和暂时满员。
...
【用户已确认】一条需求支持多人参与。页面持续展示“已找到 X/Y 人”；达到目标人数后显示“已找齐 X/Y 人”，不自动关闭需求，也不取消未到期邀请。
...
- BR-046：普通成员可在活动开始前退出；活动开始后退出入口关闭。【AI 补充，待确认】
- BR-047：发布者不能直接退出；发布者取消活动会终止活动并通知全部成员。【AI 补充，待确认】
- BR-048：发布者不能直接移除成员；屏蔽成员不会将其从已加入活动中自动移除。【AI 补充，待确认】
...
【原文已有】活动通过结构化安排卡确认日期、时间、参与方式、校区、集合地点和准备事项。发布者保存安排版本，当前成员逐人确认；沉默不视为确认。
...
6. 发布者修改关键字段时创建新版本，旧确认全部失效；仅修改准备事项时不强制重置。【AI 补充，待确认】
...
- BR-053：准备事项变更不重置确认，但必须生成变更记录并通知成员。【AI 补充，待确认】
...
【用户已确认】用户加入活动后，可以主动向本活动当前成员公开联系方式；默认不公开，可随时关闭。退出活动后立即停止展示。
...
- BR-065：活动结束 30 天后删除联系方式内容和公开状态。【AI 补充，待确认】
...
【用户已确认】已加入成员可主动请求 AI 生成 3 条破冰话术。话术可完整编辑和复制，系统不得自动生成、自动发送或读取隐藏资料和历史聊天。本期 AI 为模拟服务。
...
- BR-072：模拟 AI 返回内容需通过本地敏感词与骚扰表达过滤；不当内容不展示。【AI 补充，待确认】
- BR-073：单用户 10 分钟内最多生成 10 次，超过后暂时限流。【AI 补充，待确认】
...
【原文已有】关键业务状态变化生成站内模拟通知。通知只在小程序内展示，不表现为系统推送、短信或真实服务消息。
...
【AI 补充，待确认】用户可在候选详情、邀请详情或成员详情中屏蔽另一用户。屏蔽后双方不再互为候选；双方之间未接受的邀请失效。为了避免首版缺少 G3 数据来源，本功能列为 P1 安全能力。

### 对应用户故事

作为用户，在不希望再与某人产生匹配或邀请时，我想屏蔽对方，以便双方不再出现在彼此的候选和邀请中。【AI 补充，待确认】
...
【原文已有】记录发布、候选、邀请、活动、安排和 AI 辅助的非敏感行为事件，用于计算第 1.3 节指标。事件不记录联系方式、性别原值、自由文本或 AI 话术原文。
...
本功能无独立用户页面；隐私政策中需说明行为数据用途。【AI 补充，待确认】
...
- BR-091：事件失败不能阻断用户主流程，失败记录进入本地重试队列，最多重试 3 次。【AI 补充，待确认】
...
> 本章数值均为【AI 补充，待确认】的首版工程基线，不代表现有系统已经达到。技术评审可在不降低用户关键体验和数据安全的前提下调整。
...
| 事件 ID | 事件名称 | 触发时机 | 关键参数 | 页面 | 分析用途 | 来源状态 |
|---|---|---|---|---|---|---|
| EV-001 | auth_mock_success | 模拟认证成功 | school_code、campus_code、test_account_flag | 模拟认证页 | 认证漏斗 | 【AI 补充，待确认】 |
| EV-002 | demand_form_start | 用户首次修改任一发布字段 | category | 发布页 | 发布漏斗分母 | 【AI 补充，待确认】 |
| EV-003 | demand_publish_success | 服务端发布成功 | category、item_code、online_flag、target_count | 发布页 | 有效发布率 | 【原文已有】 |
| EV-004 | demand_publish_fail | 服务端发布失败 | error_code、field_code | 发布页 | 校验问题定位 | 【AI 补充，待确认】 |
| EV-005 | match_result_view | 候选结果成功返回 | category、candidate_count、rule_version | 候选页 | 候选非空率 | 【原文已有】 |
| EV-006 | empty_result_view | candidate_count=0 | category、limited_condition_codes | 候选页 | 空结果原因 | 【原文已有】 |
| EV-007 | condition_adjust | 用户保存关键条件修改 | changed_field_codes、before_empty_flag | 修改页 | 空结果恢复率 | 【原文已有】 |
| EV-008 | candidate_detail_view | 候选详情展示成功 | candidate_rank、reason_count | 候选详情 | 候选查看深度 | 【AI 补充，待确认】 |
| EV-009 | invite_send_success | 邀请事务成功 | active_invite_count、expire_minutes | 邀请确认页 | 邀请量与上限 | 【原文已有】 |
| EV-010 | invite_send_fail | 邀请事务失败 | error_code | 邀请确认页 | 失败原因 | 【AI 补充，待确认】 |
| EV-011 | invite_accept_success | 接受事务成功 | current_count、target_count、overlap_demand_flag | 邀请详情 | 邀请接受率 | 【原文已有】 |
| EV-012 | invite_decline_success | 拒绝成功 | remaining_minutes | 邀请详情 | 邀请结束口径 | 【AI 补充，待确认】 |
| EV-013 | activity_full | 当前人数首次达到目标 | current_count、active_invite_count | 活动详情 | 满员行为 | 【原文已有】 |
| EV-014 | member_exit | 成员退出成功 | before_count、after_count、invite_recovered_count | 活动详情 | 名额恢复 | 【原文已有】 |
| EV-015 | arrangement_create | 新安排版本创建成功 | version_no、changed_field_codes | 编辑安排 | 版本变化 | 【AI 补充，待确认】 |
| EV-016 | arrangement_confirm | 成员确认当前版本 | version_no、confirmed_count、member_count | 活动详情 | 全员确认率 | 【原文已有】 |
| EV-017 | contact_visibility_change | 联系方式公开状态变化 | open_flag、contact_type | 联系方式设置 | 隐私功能使用 | 【AI 补充，待确认】 |
| EV-018 | icebreaker_generate | 模拟 AI 成功返回 | output_count、latency_bucket | AI 破冰页 | 辅助功能使用 | 【AI 补充，待确认】 |
| EV-019 | icebreaker_copy | 用户复制话术 | edited_flag、text_length_bucket | AI 破冰页 | 话术采用行为 | 【原文已有】 |
| EV-020 | user_block_success | 屏蔽成功 | source_page | 屏蔽确认 | 安全行为 | 【AI 补充，待确认】 |
| EV-021 | notification_open | 用户打开通知 | notification_type、target_state | 通知中心 | 通知到达路径 | 【AI 补充，待确认】 |
...
以上看板为【AI 补充，待确认】；首版可先通过测试日志验证事件完整性，真实试点前再决定数据平台实现。

## 8.3 效果评估方案

【AI 补充，待确认】首版不开展 A/B 实验，原因是供需密度和业务基线尚未建立。采用单版本基线观察：连续 4 周且积累不少于 100 条有效发布需求后，按运动、学习、娱乐分别计算第 1.3 节指标。
...
4. 若任一核心事件缺失率超过 1%，该周期数据不得用于效果结论。【AI 补充，待确认】
...
|---|---|---|---|---|
| 微信小程序运行环境 | 微信平台 | 页面容器、网络、剪贴板 | 无法进入或复制话术 | 【待研发确认】 |
| 测试账号配置 | 产品/研发 | 模拟学校、校区和身份 | 无法完成认证和同校匹配 | 【待产品确认】 |
| 校区与事项词表 | 产品配置 | 表单枚举和匹配标准化 | 无法发布或候选大量为空 | 【待产品确认】 |
| 模拟 AI 服务 | 研发 | 固定或规则化生成 3 条话术 | 降级为手写，不阻断主流程 | 【待研发确认】 |
| 模拟通知服务 | 研发 | 创建站内通知记录 | 用户需刷新详情查看状态 | 【待研发确认】 |
| 数据采集与看板 | 数据/研发 | 事件上报和指标计算 | 无法完成效果评估 | 【待数据确认】 |
| 隐私与合规评审 | 产品/法务 | 字段、文案和保留期限审查 | 不得进入真实用户试点 | 【待产品确认】 |

## 9.2 风险评估

| 风险编号 | 风险 | 概率 | 影响 | 应对方案 | 来源状态 |
|---|---|---:|---:|---|---|
| RISK-01 | 事项名称分散导致相同需求无法匹配 | 高 | 高 | 使用受控词表；其他事项按规范化完全一致；试点后复核词表 | 【原文已有】 |
| RISK-02 | 三个类别差异过大，通用字段不足 | 中 | 高 | 首版只将通用字段作为硬筛；类别补充字段逐项验证 | 【原文已有】 |
| RISK-03 | 供需密度不足导致大量空结果 | 高 | 高 | 如实展示空结果；按事项、校区和时间观察，不注入候选 | 【原文已有】 |
| RISK-04 | 模拟认证被误认为真实身份保障 | 中 | 高 | 相关页面持续标注；隐私说明明确边界 | 【用户已确认】 |
| RISK-05 | 多人并发接受导致超员 | 中 | 高 | 事务锁、幂等键和服务端人数校验 | 【原文已有】 |
| RISK-06 | 性别信息引发隐私或歧视争议 | 中 | 高 | 默认不限；允许不愿透露；候选卡不展示原值 | 【原文已有】 |
| RISK-07 | AI 输出不当或被误认为代发 | 中 | 中 | 主动触发、过滤、可编辑、复制后明确未发送 | 【用户已确认】 |
| RISK-08 | 联系方式泄露 | 中 | 高 | 默认关闭、加密存储、成员权限、退出后隐藏、30 天删除 | 【AI 补充，待确认】 |
| RISK-09 | 重叠需求形成重复活动 | 中 | 高 | 接受前影响确认；重叠需求暂停；发出邀请撤回 | 【AI 补充，待确认】 |
| RISK-10 | 没有原始调研材料导致需求优先级失真 | 高 | 中 | 回收访谈纪要和问卷；所有假设保持待验证标识 | 【原文已有】 |

概率和影响分为低、中、高；评审时由产品、研发、测试共同确认。

## 9.3 技术约束与前提假设

1. 【用户已确认】真实校内认证当前不可用，本期不得把测试字段描述为官方认证。
2. 【AI 补充，待确认】服务端采用关系型数据存储，以事务保证邀请接受、成员写入和人数更新的一致性。
3. 【AI 补充，待确认】需求、邀请和安排对象均包含版本号，写操作使用乐观锁或等效方案。
4. 【AI 补充，待确认】匹配规则使用可配置版本号；历史邀请保留创建时的规则版本用于审计，但接受时执行最新资格规则。
5. 【原文已有】AI 不参与资格过滤、排序、性别推断或同义词推断。
6. 【AI 补充，待确认】候选计算不承诺实时推送；用户进入页面或手动刷新时重新计算。

---

# 10 项目计划

> 当前没有团队规模、负责人和发布日期，不能编造具体日历排期。以下为【AI 补充，待确认】的里程碑门禁，日期由负责人在评审后填写。

## 10.1 里程碑

| 里程碑 | 完成条件 | 计划日期 | 负责人 |
|---|---|---|---|
| M1 需求评审 | KD、FR、BR、NFR 和未决问题全部有结论 | 【待确认】 | 产品负责人 |
| M2 交互评审 | P01—P12 页面和异常状态原型完成 | 【待确认】 | 设计负责人 |
| M3 技术评审 | 数据模型、接口、事务、限流和降级方案通过 | 【待确认】 | 研发负责人 |
| M4 测试评审 | P0/P1 用例、测试账号和数据集准备完成 | 【待确认】 | 测试负责人 |
| M5 开发完成 | 代码合并，单元测试和接口测试通过 | 【待确认】 | 研发负责人 |
| M6 提测 | 冒烟用例通过，测试环境数据可复现 | 【待确认】 | 研发/测试 |
| M7 发布评审 | 阻断缺陷为 0，上线清单完成，回滚验证通过 | 【待确认】 | 全体负责人 |
| M8 首版发布 | 按灰度方案开放 | 【待确认】 | 产品/研发 |

## 10.2 发布策略

【AI 补充，待确认】采用测试账号白名单发布，不直接向全部真实用户开放：
...
- 重复接受产生重复成员。
- 模拟能力未标识而被展示为真实能力。
- P0 写接口错误率连续 10 分钟超过 1%。【AI 补充，待确认】

回滚方式：关闭新发布和新邀请入口，保留只读详情；回退至上一稳定版本；不删除已生成的数据，待修复后按数据修复脚本处理。【AI 补充，待确认】
...
【AI 补充，待确认】当连续 4 周且有效发布需求达到 100 条后：
...
|---|---|---|---|---|
| P01 | 模拟认证页 | FR-001 | 【待补充】 | 【待补充】 |
| P02 | 首页 | FR-002、FR-010 | 【待补充】 | 【待补充】 |
| P03 | 发布/修改需求页 | FR-002 | 【待补充】 | 【待补充】 |
| P04 | 候选结果页 | FR-003 | 【待补充】 | 【待补充】 |
| P05 | 候选详情页 | FR-003、FR-004、FR-011 | 【待补充】 | 【待补充】 |
| P06 | 邀请确认页 | FR-004 | 【待补充】 | 【待补充】 |
| P07 | 我的邀请/邀请详情 | FR-005 | 【待补充】 | 【待补充】 |
| P08 | 活动详情/成员列表 | FR-006、FR-007 | 【待补充】 | 【待补充】 |
| P09 | 安排编辑/差异页 | FR-007 | 【待补充】 | 【待补充】 |
| P10 | 联系方式设置 | FR-008 | 【待补充】 | 【待补充】 |
| P11 | AI 破冰页 | FR-009 | 【待补充】 | 【待补充】 |
| P12 | 通知中心 | FR-010 | 【待补充】 | 【待补充】 |
| P13 | 已屏蔽用户 | FR-011 | 【待补充】 | 【待补充】 |

## 12.3 未决问题清单

| 编号 | 未决问题 | 当前默认方案 | 影响范围 | 决策人 | 状态 |
|---|---|---|---|---|---|
| OQ-001 | 是否正式确定微信小程序 | 按微信小程序设计 | 全部页面与兼容性 | 产品负责人 | 待确认 |
| OQ-002 | 2—4 人上限是否适用于全部事项 | 统一 2—4 人 | 表单、名额、邀请 | 产品负责人 | 待确认 |
| OQ-003 | 初始事项词表是否需要调整 | 使用 KD-08 词表 | 发布与匹配 | 产品负责人 | 待访谈验证 |
| OQ-004 | 同校跨校区是否允许线下匹配 | 首版不允许 | 匹配与安排 | 产品负责人 | 待确认 |
| OQ-005 | 补充字段何时升级为硬条件 | 首版均不升级 | 候选质量 | 产品负责人 | 待数据验证 |
| OQ-006 | 是否保留屏蔽功能为 P1 | 当前保留 | 安全、匹配、邀请 | 产品负责人 | 待确认 |
| OQ-007 | 联系方式保留 30 天是否合规 | 暂定 30 天 | 隐私与存储 | 产品/法务 | 待确认 |
| OQ-008 | 准备事项变更是否重置确认 | 默认不重置 | 安排版本 | 产品负责人 | 待确认 |
| OQ-009 | 活动开始后是否允许成员标记退出 | 默认不允许 | 成员状态 | 产品负责人 | 待确认 |
| OQ-010 | 真实用户试点的指标目标 | 先建立基线 | 效果评估 | 产品/数据 | 待基线 |
...
- [x] 新增的性能数值、范围和默认规则均标注为【AI 补充，待确认】或集中声明来源。
